package com.xuegao.websocket.service;
...
public class WebSocketService {
    ...
    public void sendMsg(WiselyResponse msg) {
        template.convertAndSend(Constant.webSocket.PRODUCERPATH, msg);
    }
    ...
    public void send2Users(List<String> users, WiselyResponse msg) {
        users.forEach(userName -> {
            template.convertAndSendToUser(userName, Constant.webSocket.P2PPUSHPATH, msg);
        });
    }
}