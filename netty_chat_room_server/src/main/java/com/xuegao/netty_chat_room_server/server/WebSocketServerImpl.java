package com.xuegao.netty_chat_room_server.server;
...
import com.xuegao.netty_chat_room_server.serverhandler.WebSocketServerHandler;
...
public class WebSocketServerImpl implements MyHttpService, MyWebSocketService {
    ...
    public void start() {
        ...
        bootstrap.childHandler(new ChannelInitializer<Channel>() {
            ...
            protected void initChannel(Channel channel) throws Exception {
                ...
                // 设置 websocket 服务处理方式
                pl.addLast(new WebSocketServerHandler(WebSocketServerImpl.this, WebSocketServerImpl.this));
            }
        });
        /**
         * 实例化完毕后，需要完成端口绑定
    ...
    // 链接：https://juejin.im/post/5bf8c8616fb9a04a0e2cda9e
    // 来源：掘金
