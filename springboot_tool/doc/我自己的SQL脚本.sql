...
DROP TABLE IF EXISTS sys_SysUserinfo;
create table sys_SysUserinfo
(
...
insert into sys_SysUserinfo (id, username, password, status)
...
DROP TABLE IF EXISTS `t_thumbs_up_SysUserinfo`;
CREATE TABLE `t_thumbs_up_SysUserinfo`
(
    `id`           bigint(20)                      NOT NULL AUTO_INCREMENT comment '文章id',
