...
import com.xuegao.springboot_tool.constant.aop.annotation.ServiceLimit;
...
public class GuavaLimitAspect {
    ...
    //Service层切点  限流
    @Pointcut("@annotation(com.xuegao.springboot_tool.constant.aop.annotation.ServiceLimit)")
